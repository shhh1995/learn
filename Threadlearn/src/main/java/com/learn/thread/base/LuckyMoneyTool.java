...
public class LuckyMoneyTool {
     ...
     * @return
     */
//    public List<Integer> getMoneyList(int sum, int peoples){
//        List<Integer> result = new ArrayList<Integer>(peoples);
//        for(){
//
//        }
//        return result;
//    }
    ...
    public List<Integer> splitRedPacket(int money, int count) {
        List<Integer> moneys = new LinkedList<Integer>();
